...
class Scraper:
    ...
    def get_topics(self):
        ...
        for topic in names:
            ...
            elif topic['href'] == 'Prehistory': imageURL = '/images/9/99/Great_Sphinx_of_Giza_2.jpg'
            elif topic['href'] == 'Geography': imageURL = '/images/thumb/1/12/World_map_2004_CIA_large_1.7m_whitespace_removed.jpg/800px-World_map_2004_CIA_large_1.7m_whitespace_removed.jpg'
            elif topic['href'] == 'Continents': imageURL = '/images/thumb/0/0f/LocationAfrica.png/300px-LocationAfrica.png'
            elif topic['href'] == 'Countries': imageURL = '/images/thumb/1/19/Afghanistan_%28orthographic_projection%29.svg/350px-Afghanistan_%28orthographic_projection%29.svg.png'
            elif topic['href'] == 'Cities': imageURL = '/images/thumb/6/6d/Flag_of_Amsterdam.svg/180px-Flag_of_Amsterdam.svg.png 1.5x, /images/thumb/6/6d/Flag_of_Amsterdam.svg/240px-Flag_of_Amsterdam.svg.png 2x'
            elif topic['href'] == 'Bodies_of_water': imageURL = '/images/thumb/6/6f/Mouths_of_amazon_geocover_1990.png/300px-Mouths_of_amazon_geocover_1990.png'
            elif topic['href'] == 'Mountain_and_desert': imageURL = '/images/thumb/0/0d/L%C3%BCnersee_vom_Saulakopf_1.JPG/200px-L%C3%BCnersee_vom_Saulakopf_1.JPG'
            elif topic['href'] == 'Biography': imageURL = '/images/thumb/a/a8/Sarah_Bernhardt_-_Project_Gutenberg_eText_19955.jpg/200px-Sarah_Bernhardt_-_Project_Gutenberg_eText_19955.jpg'
            elif topic['href'] == 'Inventors': imageURL = '/images/thumb/2/2b/Archimedes_%28Idealportrait%29.jpg/541px-Archimedes_%28Idealportrait%29.jpg'
            elif topic['href'] == 'Composers': imageURL = '/images/thumb/6/6f/Beethoven.jpg/300px-Beethoven.jpg'
            elif topic['href'] == 'Explorers': imageURL = '/images/thumb/0/06/CristobalColon.jpg/300px-CristobalColon.jpg'
            elif topic['href'] == 'Philosophy': imageURL = '/images/thumb/a/a4/Socrates_Louvre.jpg/300px-Socrates_Louvre.jpg'
            elif topic['href'] == 'Psychology': imageURL = '/images/thumb/b/b4/Sixteen_faces_expressing_the_human_passions._Wellcome_L0068375_%28cropped%29.jpg/180px-Sixteen_faces_expressing_the_human_passions._Wellcome_L0068375_%28cropped%29.jpg'
            elif topic['href'] == 'Religion': imageURL = '/images/thumb/5/50/Brahma_Halebid.jpg/334px-Brahma_Halebid.jpg'
            elif topic['href'] == 'Family': imageURL = '/images/thumb/e/e5/Paus_family_portrait_NFB-18645.jpg/300px-Paus_family_portrait_NFB-18645.jpg'
